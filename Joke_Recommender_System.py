...
# We start by learning a lower dimensional vector representation for users and jokes, using the training data
...
# We then create a function to calculate the mean squared error as a function of d, and the Estimated Matrix
...
'''' Alternative Minimization Scheme '''
...
Kaggle_set = genfromtxt('joke_data/query.txt', delimiter=',') 
